...
namespace MsbtLib.Controls.EUI
{
    internal class ChoiceFour : Control
    {
        ...
        {
            Regex pattern = new(@"<choice4\s0=(\d+)\s1=(\d+)\s2=(\d+)\s3=(\d+)\sdefault=(\d)\scancel=(\d)\s/>");
            ...
            if (!m.Success)
            {
                throw new ArgumentException(@"Proper usage: <choice4 0=# 1=# 2=# 3=# cancel=# /> where all # are 16-bit 
                    ...
                    <choice4 0=34 1=33 2=7 3=8 default=0 cancel=3 /> or 
                    <choice4 0=16 1=17 2=18 3=22 default=1 cancel=3 />");
            }
        ...
        {
            return $"<choice4 0={_choice0} 1={_choice1} 2={_choice2} 3={_choice3} default={_defaultIndex} cancel={_cancelIndex} />";
        }
    }
}
